      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('staff.dashboard.index') }}" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Request::segment(2) == 'info-staff' ? 'active' : '' }}">
              <a href="{{ route('staff.info-staff.edit', auth('staff')->user()->id) }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user-circle"></i>
                <div data-i18n="Analytics">Staff Information</div>
              </a>
            </li>
