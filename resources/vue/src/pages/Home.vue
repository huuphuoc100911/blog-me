<template>
    ...
    <!-- <section class="hero-section">
        <div class="hs-slider owl-carousel">
            <div class="hs-item" style="background-image: url('/assets/user/img/hero/hero-1.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
            ...
            <div class="hs-item" style="background-image: url('/assets/user/img/hero/hero-2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hs-text">
    ...
    <section class="services-section spad mt-5">
        <div class="container">
            <div class="row">
    ...
    <section class="categories-section">
        <div class="container">
            ...
            <div class="categories-slider owl-carousel">
                <div class="cs-item">
                    <div class="cs-pic" style="background-image: url('/assets/user/img/categories/cat-1.jpg')"></div>
                    <div class="cs-text">
                        <h4>Animal</h4>
                ...
                <div class="cs-item">
                    <div class="cs-pic" style="background-image: url('/assets/user/img/categories/cat-2.jpg')"></div>
                    <div class="cs-text">
                        <h4>Natural</h4>
                ...
                <div class="cs-item">
                    <div class="cs-pic" style="background-image: url('/assets/user/img/categories/cat-3.jpg')"></div>
                    <div class="cs-text">
                        <h4>Potrait</h4>
                ...
                <div class="cs-item">
                    <div class="cs-pic" style="background-image: url('/assets/user/img/categories/cat-4.jpg')"></div>
                    <div class="cs-text">
                        <h4>Animal</h4>
                        <span>120 pictures</span>
                    </div>
                ...
                <div class="cs-item">
                    <div class="cs-pic" style="background-image: url('/assets/user/img/categories/cat-5.jpg')"></div>
                    <div class="cs-text">
                        <h4>Animal</h4>
                        <span>120 pictures</span>
                    </div>
